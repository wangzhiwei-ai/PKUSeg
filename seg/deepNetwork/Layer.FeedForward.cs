...
namespace Program
{
    ...
    public class FeedForwardLayer
    {
        ...
        public FeedForwardLayer(double upbound=Global.upbound)
        {
            _w = Matrix.newMatrix_random(Global.outputDimension, Global.hiddenDim, upbound);
            _b = new Matrix(Global.outputDimension);
        }
