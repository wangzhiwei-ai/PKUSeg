...
namespace Program1
{
    class Global
    {
        ...
        public static bool wordFeature  = true;
        //ADF training
        ...
        public static string outDir = "";
        public static string testrawDir = "rawinputs/";
        public static string testinputDir = "inputs/";
        public static string tempDir = "temp/";
        public static string testoutputDir = "entityoutputs/";

        public static bool GL_init = true;
        public static List<int> groupStart;
        public static List<int> groupEnd;
        public static string weightRegMode = "L2";//choosing weight regularizer: L2, L1, GL (groupLasso)
        public static List<bool> groupTrim;

        public static string fTrain = tempFile + "/" + "train.txt";
        public static string fTest = tempFile + "/" + "test.txt";
        public static string fDev = tempFile + "/" + "dev.txt";


        public static bool dev = false;//for testing also on dev data
        public static bool formatConvert = true;
        ...
        public static string fFeatureTrain = tempFile + "/" + "ftrain.txt";
        public static string fGoldTrain = tempFile + "/" + "gtrain.txt";
        public static string fFeatureTest = tempFile + "/" + "ftest.txt";
        public static string fGoldTest = tempFile + "/" + "gtest.txt";


        
        public const string fModel = "model/crf/model.txt";
        public const string modelDir = "model/crf/";
        ...
        static void getChunkTagMap()
        {
            ...
            StreamReader sr = new StreamReader(Global.modelDir + "/" + "tagIndex.txt");
