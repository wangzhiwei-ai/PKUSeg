...
1. 准确率高。相比于传统的分词工具包，我们的工具包在不同领域的数据上都大幅提高了分词的准确度，其中分词错误率在MSRA和CTB8的数据上分别降低了79.33%和63.67%。
...
```
[msra](https://drive.google.com/open?id=1c1Dn2aKy5KFJWir2-GkXhG1XeaGVW1wE)：在MSRA（新闻语料）上训练的模型
