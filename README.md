...
1. [msra](https://pan.baidu.com/s/1z3r_90kzSUjISjoc5OxLUA)：在MSRA（新闻语料）上训练的模型
2. [ctb8](https://pan.baidu.com/s/1HTzMheAteqCcCwLlNzGVPQ)：在CTB8（新闻文本及网络文本的混合型语料）上训练的模型
3. [weibo](https://pan.baidu.com/s/1-7oOdCHEtPtviMSPpzx_Ug)：在微博（网络文本语料）上训练的模型
