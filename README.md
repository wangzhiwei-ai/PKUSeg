...
### 预训练模型
分词模式下，用户需要在seg/bin/x64/Release/model加载预训练好的模型，数据可以在https://drive.google.com/drive/folders/1X7Yfmfiakgt7DYE86IEFT1wZdrEhOasy 网址下载，根据具体需要，用户可以自定义的选择不同的预训练模型。以下是对模型的说明：
